...
Config.Strings = {
	...
	CancelFuelingPump = "Presiona ~g~E ~w~para cancelar de repostar",
	CancelFuelingJerryCan = "Presiona ~g~E ~w~para cancelar de repostar",
	NotEnoughCash = "No tienes suficiente dinero",
	RefillJerryCan = "Presiona ~g~E ~w~ para rellenar el bidon por ",
...
if not Config.UseESX then
	Config.Strings.PurchaseJerryCan = "Presiona ~g~E ~w~para comprar un bidon"
	Config.Strings.RefillJerryCan = "Presiona ~g~E ~w~ para rellenar el bidon"
end
